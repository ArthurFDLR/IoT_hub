...
public class Integration_4 implements AutoCloseable {

	private static final String broker = "tcp://127.0.0.1";
	private static final String topicPrefix = System.currentTimeMillis()+"/integration_4/iot_hub";
	...
	private static final Logger logger = LoggerFactory.getLogger(Integration_4.class);

	private final MqttController mqtt;

	private Integration_4() throws Exception {
	...
	public static void main(String[] args) throws Exception {
		File dbFile = new File("./data/test_integration_4.db"); 
		dbFile.delete();
		...
		HubConfig hubConfig = new HubConfig(8088, broker, "testee/iot_hub", topicPrefix,  "test_integration_4.db");

		try (
			Integration_4 p4 = new Integration_4();
	...
	static String getStates1() throws Exception {
		...
		logger.debug("Integration_4: getState1 {}", ret);
		return ret;
	}
	...
	static String getStates2() throws Exception {
		...
		String ret = String.join("", states.values());
		logger.debug("Integration_4: getState2 {}", ret);
		return ret;
	}
	...
	static String getStates3() throws Exception {
		...
		String ret = String.join("", states.values());
		logger.debug("Integration_4: getState3 {}", ret);
		return ret;
	}
	...
	static String getStates4(MqttController mqtt) throws Exception {
		...
		String ret = String.join("", states.values());
		logger.debug("Integration_4: getState4 {}", ret);
		return ret;
	}
