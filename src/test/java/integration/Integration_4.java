...
public class Integration_4 implements AutoCloseable {
	...
	public static void main(String[] args) throws Exception {
		File dbFile = new File("./data/integration_4.db"); 
		dbFile.delete();
		...
		HubConfig hubConfig = new HubConfig(8088, broker, "testee/iot_hub", topicPrefix,  "integration_4.db");
