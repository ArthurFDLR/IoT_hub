...
public class Integration_3 implements AutoCloseable {
	...
	private Integration_3() throws Exception {
		this.mqtt = new MqttController(broker, "checker/iot_sim", topicPrefix);
		this.mqtt.start();
	}
